...
export default function CurrentLap({ finishFlag, lapsLabel, lapsChangeAnim }) {
  return (
    <div 
      className={`rounded-xl overflow-hidden shadow-[0_8px_28px_rgba(0,0,0,0.35)] backdrop-blur-sm h-[45px] flex items-center px-4 font-bold tracking-tight whitespace-nowrap border border-white/10 ${finishFlag ? "w-[140px]" : ""}`}
      style={finishFlag ? {
        backgroundColor: "#fff",
