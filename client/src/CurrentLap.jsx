...
export default function CurrentLap({ finishFlag, lapsLabel, lapsChangeAnim }) {
  return (
    <div 
      className={`relative rounded-xl overflow-hidden shadow-[0_8px_28px_rgba(0,0,0,0.5)] h-[45px] flex items-center px-4 font-bold tracking-tight whitespace-nowrap border border-white/5 transform-gpu ${finishFlag ? "w-[140px]" : ""}`}
      style={{
        position: 'relative',
        ...(finishFlag ? {
          backgroundColor: "#fff",
